    ...
    <div class="columns is-mobile is-multiline">
        <div class="column is-4-desktop is-12-mobile">
            <figure class="image is-128x128 mx-auto">
                <img src="/Al-Nizami-Darbar/images/og-logo.png">
            </figure>
            <p class="has-text-weight-normal has-text-white has-text-centered is-size-7 mt-3">
        ...
        <div class="column is-2-desktop is-6-mobile has-text-centered">
            <ul class="has-text-weight-semibold is-size-6 has-text-grey-dark">
                ...
                <li><a href="/Al-Nizami-Darbar/src/contact-us/contact.php" class="is-size-7 l">Contact us</a></li>
            </ul>
        </div>
        <div class="column is-2-desktop is-6-mobile has-text-centered">
            <ul class="has-text-weight-semibold is-size-6 has-text-grey-dark">
        ...
        <div class="column is-4-desktop is-12-mobile has-text-centered">
            <div class="details">
                <div class="address d-flex justify-content-start pb-3">
                    <i class="fas fa-map has-text-white fa-2x"></i>
                    <a href="https://www.google.com/maps/place/Al+Nizami+Darbar/@19.1098817,72.8755438,15z/data=!4m2!3m1!1s0x0:0xc1192273cb239426?sa=X&ved=2ahUKEwicgKfD3-nvAhVIzTgGHZbKC88Q_BIwF3oECCAQBQ" class="has-text-weight-semibold is-size-7 add ml-3 has-text-left">Shop no.1, Noori Baug, Marol Airport road Metro station, opposite Leela Hotel, Andheri East, Mumbai, Maharashtra 400059</a>
                </div>
                <div class="contact d-flex justify-content-start py-4">
                    <i class="fas fa-phone has-text-white fa-2x"></i>
                    <p class="has-text-weight-semibold is-size-7 add ml-3 has-text-left"><a href="tel:7045720000" class="pno">7045720000</a> / <a href="tel:7045730000" class="pno">7045730000</a></p>
                </div>
                <div class="email d-flex justify-content-start pt-4">
                    <i class="fas fa-envelope has-text-white fa-2x"></i>
                    <a href="mailTo:contact@alnizamidarbar.com" class="has-text-weight-semibold is-size-7 add ml-3 has-text-left pt-1">contact@alnizamidarbar.com</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="footer-copyright text-center py-3 has-text-grey-light">
    ...
    <a href="/Al-Nizami-Darbar" class="has-text-white has-text-weight-bold">Al Nizami Darbar</a>
</div>